...
type ScooterResp struct {
	...
	BatterySoc          int16  `json:"batterySoc,omitempty"`
	Odometer            int32  `json:"odometer,omitempty"`
	BatteryTemperature  int16  `json:"batteryTemperature,omitempty"`
	MotorTemperature    int16  `json:"motorTemperature,omitempty"`
	InverterTemperature int16  `json:"inverterTemperature,omitempty"`
	Range               int16  `json:"range,omitempty"`
